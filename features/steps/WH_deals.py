...
#         assert product_list[i].find_element(*PRODUCT_NAME), f'Expected item to have product name'
    for item in product_list:
        if "Hundreds more in store" not in item.text:
            assert 'Regular' in item.text
